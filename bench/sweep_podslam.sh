...
export UV_NO_SYNC=1 OMP_NUM_THREADS="${PODSLAM_THREADS:-2}" OPENBLAS_NUM_THREADS="${PODSLAM_THREADS:-2}" MKL_NUM_THREADS="${PODSLAM_THREADS:-2}" PODSLAM_THREADS="${PODSLAM_THREADS:-2}"
