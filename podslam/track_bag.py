...
def main(argv=None) -> int:
    ...
    ap.add_argument("--dyn-weight", action="store_true", default=True, help="per-landmark temporal-consistency down-weighting (DEFAULT ON since 2026-09-01)")
    ap.add_argument("--no-dyn-weight", dest="dyn_weight", action="store_false", help="disable dyn-weight (legacy behaviour)")
